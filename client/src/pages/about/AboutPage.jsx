    ...
    <main className="route-shell about-page-shell">
      ...
      <section className="about-page-intro">
        <article>
          ...
          <p>
            ...
            сигурност и човешка подкрепа. Тук приемаме животни, които са били изоставени, пострадали или са живели дълго
            време в тежки условия, и им помагаме да възстановят здравето и доверието си. Вярваме, че всяко животно
            заслужава спокойна среда, внимание и възможност да бъде обичано. Чрез тази платформа искаме не само да
            представим животните в приюта, но и да дадем на хората лесен начин да помогнат — чрез осиновяване,
      ...
      <section className="about-page-work-card">
        ...
        <p>
          ...
          наблюдение, социализация и подготовка за бъдещо осиновяване. Нашата работа е насочена не само към физическото
          възстановяване на животните, но и към това те да се почувстват спокойни, защитени и готови за ново начало.
          Всеки случай изисква индивидуален подход, търпение и внимание, защото зад всяко спасено животно стои различна
          история и различна нужда от подкрепа. Именно затова помощта на хората е толкова ценна — тя ни позволява да
          осигурим по-добра среда, повече грижа и повече възможности за животните, които разчитат на нас.
        </p>
      </section>
